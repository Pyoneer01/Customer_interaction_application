...
def get_groq_response(user_message):
    try:
        ...
        chat_completion = client.chat.completions.create(
            messages=[
                {"role": "system", "content": "you are a helpful assistant for an e-commerce company. Give a meaningful response within 100 tokens"},
...
def chatbot_page():
    ...
    # User input for chat
    user_message = st.text_input("Your message", key="user_message", placeholder="Type your message here...")
